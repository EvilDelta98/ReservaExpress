...
<body>
    <!--- ¿USAMOS ESTA VISTA? CREO QUE NO LA USARÍAMOS EN NUESTRO SISTEMA, pero podemos reusar --->
    <center>
        <br>
        <br>
        ...
        <form class="form-label" id="formReseteo" method="POST" action=" ">
            ...
            <div class=" col-sm-2"> 
                ...
                <input  maxlength="255" minlength="8" required  type="password" name="pass2" id="pass2">
            </div>
