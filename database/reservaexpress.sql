...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2024 at 09:33 PM
...
INSERT INTO `usuario` (`id`, `nombre`, `apellido`, `correo`, `cuenta`, `clave`, `tipoUsuario`, `estado`, `fechaAlta`) VALUES
(2, 'Franco', 'Brandan', 'febrandan@yahoo.com.ar', 'febrandan', '202cb962ac59075b964b07152d234b70', 1, 0, '2024-01-24 17:05:00'),
(29, 'Melany Elizabeth', 'Ernalz', 'melany@melany.com', 'mel22', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 18:32:10'),
(30, 'fhsfsj', 'adasd', 'correo@asdasd', 'asdasd', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 18:55:44'),
(31, 'uikujhy', 'juykiuyhg', 'rgetytuio9', 'tgytuiyhgg', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 18:58:05'),
(32, 'nombrecito', 'apellidot', 'corero@aodasdo', 'usuario2', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 19:01:04'),
(33, 'operador', 'operadro', 'correo@correo', 'febrandan2', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 19:04:31'),
(34, 'bfehaerh', 'fbebrearbae', 'osfjgsjgskgjs', 'ajiadoio', '202cb962ac59075b964b07152d234b70', 0, 0, '2024-01-30 19:09:12');
...
ALTER TABLE `socio`
  ...
  ADD KEY `tipoProfesor` (`tipoSocio`);
...
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `carrera` FOREIGN KEY (`carrera`) REFERENCES `carreras` (`id`);
...
--
ALTER TABLE `socio`
  ADD CONSTRAINT `tipoAlumno` FOREIGN KEY (`tipoSocio`) REFERENCES `alumno` (`id`),
  ADD CONSTRAINT `tipoProfesor` FOREIGN KEY (`tipoSocio`) REFERENCES `profesor` (`id`);
